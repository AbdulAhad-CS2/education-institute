            ...
            <aside className="w-64 bg-white border-r border-zinc-200 hidden md:flex flex-col fixed h-full">
                ...
                <div className="flex-1 overflow-y-auto py-6 px-4 space-y-2">
                    <div className="mb-6 px-2">
                        <h3 className="text-xs font-semibold text-zinc-500 uppercase tracking-wider mb-2">Teacher Panel</h3>
                ...
                <div className="p-4 border-t border-zinc-100">
                    <div className="flex items-center gap-3 mb-4 px-2">
                        ...
                        <div className="overflow-hidden">
                            ...
                            <p className="text-xs text-zinc-500 capitalize">{user?.role || "Teacher"}</p>
                        </div>
                    </div>
                    <form action={logout}>
